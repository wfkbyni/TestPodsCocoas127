...
- (ZZCountingLabel *)progressLabel {
    if (!_progressLabel) {
        ...
        _progressLabel.textColor = [UIColor colorWithRed:68/255.0 green:72/255.0 blue:94/255.0 alpha:1.0];
        _progressLabel.textAlignment = NSTextAlignmentCenter;
        _progressLabel.font = [UIFont fontWithName:@"Rubik-Regular" size: 13];
